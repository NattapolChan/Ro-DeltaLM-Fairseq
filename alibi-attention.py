...
class ALiBiMultiHeadAttention(MultiheadAttention):
    def __init__(
            ...
            dropout=0, bias=False, add_bias_kv=False, add_zero_attn=False, 
    ...
    def forward_alibi(
        ...
        rel_pos = get_relative_positions(seq_len).to(query.device)
        ...
        self.mask = torch.tril(torch.ones(1, 1, self.max_len, self.max_len)).to(query.device)
